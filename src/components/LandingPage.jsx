  ...
  const ModulePage = ({ mod }) => (
    <section style={{ padding: "140px 24px 80px" }}>
      <div style={{ maxWidth: 800, margin: "0 auto" }}>
        ...
        {/* Video Demo */}
        <Glass style={{ padding: 4, marginBottom: 48, overflow: "hidden" }}>
          <div style={{ position: "relative", paddingTop: "56.25%", background: "#000", borderRadius: 12, overflow: "hidden" }}>
            <div style={{ position: "absolute", inset: 0, display: "flex", alignItems: "center", justifyContent: "center", flexDirection: "column", gap: 16 }}>
              <div style={{ width: 64, height: 64, borderRadius: "50%", background: `${mod.color}20`, border: `2px solid ${mod.color}40`, display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer" }}>
                <span style={{ fontSize: 24, marginLeft: 4 }}>▶</span>
              </div>
              <span style={{ fontFamily: "'Outfit', sans-serif", fontSize: 13, color: G.textMuted }}>Watch the {mod.name} demo</span>
            </div>
          </div>
        </Glass>
